'''Menu driven code for reading multiple data from user and to perform search
and delete operation as per value
intered by the user'''
...
def delHash(value): #this function is used to delete value from hash table if present
 ...
 if(hashTable[key]==value):
  ...
  hashTable[key]=-1;
   ...
   print(value, "Not Found at", key,"th Index location");
   initial(); 
 #Actual code starting to execute from this line.
